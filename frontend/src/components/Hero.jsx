  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Divine Om Symbol - Perfectly Centered */}
        <div className="flex justify-center items-center mb-12">
          <div className="relative">
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] md:w-[280px] md:h-[280px] border-2 border-orange-400 rounded-full opacity-10 animate-spin" style={{ animationDuration: '30s' }}></div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[320px] md:h-[320px] border border-amber-300 rounded-full opacity-15 animate-spin" style={{ animationDuration: '40s', animationDirection: 'reverse' }}></div>
              
              {/* Main Om SVG - Perfectly Centered */}
              <div className="relative bg-gradient-to-br from-orange-900/20 to-amber-900/20 backdrop-blur-sm rounded-full p-8 border-2 border-orange-400/30 flex items-center justify-center">
                <svg 
                  viewBox="0 0 300 300" 
